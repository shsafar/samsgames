//
//  WebAtomicNailsGameView.swift
//  Sam's Games
//
//  AtomicNails game integrated with daily puzzle system
//

import SwiftUI
import WebKit

struct WebAtomicNailsGameView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showInstructions) {
            GameInstructionsView(gameType: .atomicNails)
        }
    }
...
struct AtomicNailsCompletedView: View {
    @Environment(\.dismiss) private var dismiss
    @Environment(\.colorScheme) var colorScheme
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: 30) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("Great job! You've finished today's Atomic Nails puzzle.")
                            .font(.system(size: 18))
